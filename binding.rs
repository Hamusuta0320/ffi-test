...
pub const __GLIBCXX__: u32 = 20231005;
...
#[test]
fn bindgen_test_layout_Human() {
    const UNINIT: ::std::mem::MaybeUninit<Human> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<Human>(),
        16usize,
        concat!("Size of: ", stringify!(Human))
    );
    assert_eq!(
        ::std::mem::align_of::<Human>(),
        4usize,
        concat!("Alignment of ", stringify!(Human))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).a) as usize - ptr as usize },
        0usize,
        concat!("Offset of field: ", stringify!(Human), "::", stringify!(a))
    );
    assert_eq!(
